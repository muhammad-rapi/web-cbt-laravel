{{-- tampilan untuk menampilkan seluruh kelas yang dibuat --}}
            ...
            <div class="course-list-container flex flex-col px-5 mt-[30px] gap-[30px]">
                ...
                @forelse ($courses as $course)
                    <div class="list-items flex flex-nowrap justify-between pr-10">
                        ...
                        @elseif ($course->category->name == 'Grapich Design')
                            <div class="flex shrink-0 w-[170px] items-center justify-center">
                        ...
                        <div class="flex shrink-0 w-[120px] items-center">
                            <div class="relative h-[41px]">
                                <div
                                    ...
                                    <a href="{{route('dashboard.course.course_students.index', ['course' => $course])}}"
                                        class="flex items-center justify-between font-bold text-sm w-full">
                                        Students
                                    </a>
