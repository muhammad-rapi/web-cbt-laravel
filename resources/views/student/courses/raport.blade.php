    ...
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                <div class="flex gap-6 items-center">
                    <div class="w-[150px] h-[150px] flex shrink-0 relative overflow-hidden">
                        <img src="{{ asset(Storage::url($course->cover)) }}" class="w-full h-full object-contain"
                            alt="icon">
                        <p
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex items-center">
                            <div class="flex gap-[10px] items-center">
                                ...
                                <p class="font-semibold">{{ $correctAnswerCount }} of {{ $totalQuestionsCount }}
                                    correct</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="result flex flex-col gap-5 mx-[70px] w-[870px] mt-[30px]">
                @forelse ($studentAnswers as $studentAnswer)
                    <div
                        ...
                        <div class="flex flex-col gap-[6px]">
                            ...
                            <p class="font-bold text-xl">{{ $studentAnswer->question->question }}</p>
                        </div>
