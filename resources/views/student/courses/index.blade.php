    ...
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="course-list-container flex flex-col px-5 mt-[30px] gap-[30px]">
                ...
                @forelse ($myCourses as $myCourse)
                    <div class="list-items flex flex-nowrap justify-between pr-10">
                        ...
                        <div class="flex shrink-0 w-[150px] items-center justify-center">
                            <p class="font-semibold">{{ $myCourse->created_at->format('F j, Y') }}</p>
                        </div>
                        @if ($myCourse->category->name == 'Programming')
                        ...
                        @elseif ($myCourse->category->name == 'Grapich Design')
                            <div class="flex shrink-0 w-[170px] items-center justify-center">
                        ...
                        <div class="flex shrink-0 w-[120px] items-center">
                            @if ($myCourse->nextQuestionId)
                                <a href="{{ route('dashboard.learning.course', ['course' => $myCourse->id, 'question' => $myCourse->nextQuestionId]) }}"
                            ...
                            @else
                                <button
                                    class="w-full h-[41px] p-[10px_20px] bg-indigo-900 rounded-full font-bold text-sm text-white cursor-not-allowed opacity-50 text-center"
                                    disabled>Results</button>
                            @endif
                        </div>
                ...
                @empty
                    <p>Anda belum terdaftar pada kelas manapun</p>
                @endforelse
            </div>
        </div>
    </section>
